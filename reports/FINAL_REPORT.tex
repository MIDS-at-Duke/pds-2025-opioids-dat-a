...
\textbf{Washington's voluntary approach was mixed.} Deaths dropped significantly ($-1.94$ per 100k), likely capturing adoption in major population centers. However, supply reductions were temporary: shipments dipped briefly but then reversed course and climbed back up (statistically significant upward trend).
...
\caption{\textbf{Washington's Reduction Was Temporary.} Red: Washington; blue dashed: 6 controls (OR, CO, MN, NV, CA, VA). Initial drop: $-13.5$M MME (p=0.004), then \textcolor{red}{upward reversal: $+6.4$M per year} (p$<$0.001). Effect evaporated by 2015.}
\end{figure}
...
\caption{\textbf{Washington Showed Significant Mortality Reduction.} Red: Washington; blue dashed: controls. A statistically significant drop occurred after 2012. Effect: $-1.94$ per 100k (p=0.007).}
\end{figure}
