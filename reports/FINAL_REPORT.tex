...
CDC WONDER suppresses death counts $<$10. Rather than imputing or aggregating (which destroys temporal variation), we treated suppressed values as missing. Counties with \textit{any} missing pre-policy death data were excluded to ensure valid parallel trends assessment. This conservative approach preserves DiD integrity.

\subsection*{Final Samples}

\textbf{Florida:} 94 counties (FL + 6 controls), 940 county-year observations

\textbf{Washington:} 68 counties (WA + 6 controls), 680 county-year observations
