...
% --- MEMO HEADER ---
\noindent
\textbf{FROM:} Tea Tafaj, Diwas Puri, Austin Zhang (Duke MIDS Data Science Team)\\
...
\noindent\fbox{%
    \parbox{0.97\textwidth}{%
        \textbf{Stakeholder:} State Health Policy Director with public health background, limited statistical training. Needs actionable evidence on regulatory vs. voluntary opioid interventions to inform budget allocation decisions.
    }%
}
...
\textbf{Florida's regulatory approach produced sustained reductions.} Opioid shipments (measured in morphine milligram equivalents, or MME) dropped by 15.4 million per 100,000 residents immediately, and the decline accelerated over time. Drug deaths fell by 2.36 per 100,000 people. Both effects are statistically significant and sustained through 2015.
...
\noindent The red line (Florida) breaks sharply downward in 2010 and continues falling. The blue dashed line (control states) keeps rising, demonstrating clear policy divergence.
...
\noindent Florida saw \textbf{2.36 fewer drug deaths per 100,000 residents} (p=0.001). For context, Florida's 2010 population was ~19 million, translating to roughly \textbf{450 lives saved per year}.
...
\noindent The red line (Washington) dips slightly in 2012-2013, then curves back upward. By 2015, it's trending \textit{above} where it would have been without the policy — a statistically significant reversal.
...
\noindent No visible divergence from control states. The estimated reduction of 1.12 deaths per 100k is \textbf{not statistically significant} (p=0.12), meaning we cannot rule out that this is just random noise.
...
\textbf{Study Design:} Difference-in-differences (DiD) regression with county fixed effects and clustered standard errors.
...
\textbf{Florida:} 608 counties (FL + 6 controls), 6,042 county-year observations (4,491 imputed)
...
\noindent\textbf{Prepared by:} Tea Tafaj, Diwas Puri, Austin Zhang\\
