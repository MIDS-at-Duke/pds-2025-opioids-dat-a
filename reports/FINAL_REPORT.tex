...
CDC WONDER suppresses death counts $<$10. Rather than imputing or aggregating (which destroys temporal variation), we treated suppressed values as missing. Counties with \textit{any} missing death data across the full study period (2006-2015) were excluded to ensure consistent county pools for pre/post comparison. This conservative approach preserves DiD integrity.

\subsection*{Final Samples}

\textbf{Florida:} 84 counties (FL + 6 controls), 840 county-year observations

\textbf{Washington:} 67 counties (WA + 6 controls), 670 county-year observations

No arbitrary population cutoffs applied (unlike alternative approaches excluding $<$20k residents).
