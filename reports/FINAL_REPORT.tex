...
\textbf{Bottom Line:} Regulatory enforcement produces durable change. Voluntary education creates temporary compliance that fades within 2 years.
...
\begin{itemize}
    \item \textbf{Causation requires parallel trends assumption.} Our analysis assumes Florida and control states would have followed similar paths without the policy. Pre-2010 trends support this, but we can't prove it with certainty.
